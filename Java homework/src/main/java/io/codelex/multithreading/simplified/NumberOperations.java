    ...
    */
    ...
    public static void main(String[] args) {
        ...
        List<Integer> numberList = createNumberList();
               ...
               Runnable task1 = ()-> {System.out.println("Total sum of numbers: "+numberList.stream().reduce(Integer::sum).get());};
               Runnable task2 = ()-> {System.out.println("Average sum of numbers: "+ numberList.stream().mapToDouble(i-> i).average().getAsDouble());};
               Runnable task3 = () -> {System.out.println("Average sum of every 2nd number: "+numberList.stream().filter(i-> numberList.indexOf(i)%2==1).mapToInt(i->i).sum());};
