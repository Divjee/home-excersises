...
public class CalculateArea {
    ...
    public static void calculateCircleArea() throws Exception {
        ...
        if (radius.compareTo(BigDecimal.ZERO) < 0) {
            throw new Exception("Radius cant be a negative value");
        } else {
            // Display output
    ...
    public static void calculateRectangleArea() throws Exception {
        ...
        if (width.compareTo(BigDecimal.ZERO) < 0 || length.compareTo(BigDecimal.ZERO) < 0) {
            throw new Exception("Can't have width or length as negative numbers");
        } else {
    ...
    public static void calculateTriangleArea() throws Exception {
        ...
        if (base.compareTo(BigDecimal.ZERO) < 0 || height.compareTo(BigDecimal.ZERO) < 0) {
            throw new Exception("Can't have base or height as negative numbers");
        } else {
